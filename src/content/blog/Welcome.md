...
1. [Programming Massively Parallel Processors Lecture Series](https://www.youtube.com/watch?v=4pkbXmE4POc&list=PLRRuQYjFhpmubuwx-w8X964ofVkW1T8O4) by Professor Izzat El Hajj from American University of Beirut
   - This one is more of a conceptual watch to act as a supplement as I go through the actual book
2. [CUDA Course](https://www.youtube.com/watch?v=86FAWCzIe_4&t=12s) on YouTube
   - Shoutout [Elliot](https://x.com/elliotarledge), great follow on Twitter. This one will be me more hands-on building projects.
...
In parallel, I'll start to build an intuition for Deep Learning and develop strong fundamentals in ML. Eventually building up to Transformers, GPT, MoE, etc. Starting with François Chollet's [Deep Learning with Python](https://deeplearningwithpython.io/) book 🙂
